...
function Slider() {
  //大盒子
  this.big_box = document.querySelector('#banner'); //大图li

  this.ul_li = this.big_box.children[0].children; //计算大图数量

  this.num = this.ul_li.length; //完善页面并返回所有的小圆点（ol li)

  this.ol_li = this.addEle(); //当前下标

  this.cur_index = 0; //添加事件
...
Slider.prototype = {
  ...
  addEvent: function addEvent() {
    ...
    var _loop = function _loop(i) {
      _this2.ol_li[i].onclick = function () {
        this.cur_index = i;
        this.slide();
      }.bind(_this2);
    };
  ...
  addEle: function addEle() {
    ...
    this.big_box.appendChild(this.lt_btn); //右按钮

    this.rt_btn = document.createElement('span');
    this.rt_btn.innerHTML = '&gt;';
    this.rt_btn.id = 'rtBtn';
    this.big_box.appendChild(this.rt_btn); //小圆点
